...
| [**5b. Pandas UDF data arrays**](5b.Dimuon_mass_spectrum_histogram_Spark_Pandas_full_formula_with_arrays_UDF_ORC_vectorized.ipynb)                                                                                                                                                                                                                                       | 58 sec    | Same as 5a, but the Pandas UDF in this case uses data in arrays and lists                                                                                                                                   |
| [**5c. Pandas UDF data arrays**](5c.Dimuon_mass_spectrum_histogram_Spark_Pandas_optimized_formula_with_arrays_UDF_ORC_vectorized.ipynb)                                                                                                                                                                                                                                  | 42 sec    | Same as 5b, but using an optimized formula that substantially reduces the amount of calculations performed                                                                                                  |
