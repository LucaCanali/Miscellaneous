...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**Benchmark tasks 1 to 5, Parquet and SparkHistogram**](HEP_benchmark/ADL_HEP_Query_Benchmark_Q1_Q5_Parquet_sparkhistogram.ipynb)                                                                                                                                                                                                       | The analysis is implemented using Apache Spark DataFrame APIi. It uses the dataset in Apache Parquet format and the histogram generation is done using the sparkhistogram package.                                                      |
