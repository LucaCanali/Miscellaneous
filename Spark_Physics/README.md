...
| [**<span style="color:red">8. DataFrame API at scale</span>**](Dimuon_mass_spectrum/8.Dimuon_mass_spectrum_histogram_Spark_DataFrame_ORC_vectorized-Large_SCALE.ipynb)                                                                                                                                                                                                    | (*)33 sec  | (*)This has processed 6.4 billion events, at scale on a cluster using 200 CPU cores.                                                                                                                        |
...
| **[H-ZZ*-4l analysis with additional processing](ATLAS_Higgs_opendata/H_ZZ_4l_analysis_extra_cuts_montecarlo_data.ipynb)**                                                                                                                                                                                                                              | Analysis with extra cuts and data operations, this uses Monte Carlo simulation data |
